...
class CalendarioController extends Controller
{
    ...
    public function show($fecha)
    {
        ...
        $fechaInicioSistema = Carbon::create(2026, 4, 13)->startOfDay();
    ...
    private function construirDatosCalendario(Request $request, bool $permitirBusqueda = true): array
    {
        Carbon::setLocale('es');
    ...
    public function asignarManual(Request $request)
{
    ...
    $asignacionBase = $this->calcularAsignacionBase(
        $fecha->copy(),
        Carbon::create(2026, 4, 13)->startOfDay(),
        $empleadosActivos,
        false
    );
