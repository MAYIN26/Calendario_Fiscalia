<style>
    ...
    .foto-lbl  { font-size: 11px; color: #94a3b8; }
    .foto-name { font-size: 13px; font-weight: 600; color: #0f172a; margin-top: 2px; }
    ...
    .upload-icon  { font-size: 22px; color: #94a3b8; margin-bottom: 6px; }
    ...
    .f-divider hr { flex: 1; border: none; border-top: 1px solid #f1f5f9; }
    .f-divider span { font-size: 11px; color: #94a3b8; white-space: nowrap; text-transform: uppercase; letter-spacing: .8px; }
    ...
    .btn-submit.crear   { background: linear-gradient(135deg, #6366f1, #a855f7); }
    .btn-submit.editar  { background: linear-gradient(135deg, #0ea5e9, #6366f1); }
...
<div class="f-grid">
    ...
    {{-- CORREO --}}
    <div class="f-group">
        <label class="f-label">Correo <span class="req">*</span></label>
    ...
    {{-- APELLIDO PATERNO --}}
    <div class="f-group">
        <label class="f-label">Apellido Paterno <span class="req">*</span></label>
    ...
    {{-- APELLIDO MATERNO --}}
    <div class="f-group">
        <label class="f-label">Apellido Materno</label>
...
{{-- FOTO --}}
<div class="f-divider">
    <hr><span>Fotografía</span><hr>
</div>

<div class="f-group">
        <label class="f-label">Foto del Empleado <span style="font-size:11px; color:#94a3b8; font-weight:400;">(Opcional)</span></label>
    @if(isset($empleados->foto))
        <div class="foto-preview">
            <img src="{{ Storage::url($empleados->foto) }}" alt="Foto actual">
            <div>
                <div class="foto-lbl">Foto actual</div>
                <div class="foto-name">{{ basename($empleados->foto) }}</div>
            </div>
        </div>
    @endif
    ...
    <div class="upload-zone" id="uploadZone">
        ...
        <div id="uploadContent">
            ...
            <div class="upload-text">
                {{ isset($empleados->foto) ? 'Haz clic para cambiar la foto' : 'Haz clic para subir una foto' }}
            </div>
            <div class="upload-hint">PNG, JPG, WEBP — máx. 2 MB</div>
        </div>
    </div>
...
<div class="f-divider"><hr></div>

{{-- SUBMIT --}}
<button type="submit" class="btn-submit {{ $modo == 'Crear' ? 'crear' : 'editar' }}">
    @if($modo == 'Crear')
        ...
        reader.onload = e => {
            document.getElementById('uploadContent').innerHTML = `
                <img src="${e.target.result}"
                     style="max-height:100px;border-radius:10px;object-fit:cover;margin-bottom:8px">
                <div class="upload-text" style="color:#10b981">
