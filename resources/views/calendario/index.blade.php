        ...
        <div class="calendar-grid">
            ...
            @foreach($diasCalendario as $dia)
                ...
                <div class="day-card
                    ...
                    {{ !empty($buscar) && !$dia['coincide_busqueda']
                        ? 'search-dim' : 
                        '' }}
                    {{ !empty($buscar) && $dia['coincide_busqueda'] 
                       ? 'search-hit' : 
                    ...
                    @if($dia['asignacion'])
                        ...
                        >
                            ...
                            <div class="assignment-box">
                                ...
                                @if(
                                    $esManual &&
                                    !empty($dia['asignacion']->empleadoOriginal)
                                )
                ...
                <tbody>
                    ...
                    @foreach($diasCalendario as $dia)
                        ...
                        @php
                            ...
                            $esManual =
                                !empty($asignacion) &&
                                !empty($asignacion->modificado_manual);
                        ...
                        <tr class="{{ $esManual ? 'manual-row' : '' }}">
                            ...
                            <td>
                                ...
                                @if(
                                    $esManual &&
                                    !empty($asignacion->empleadoOriginal)
                                )
